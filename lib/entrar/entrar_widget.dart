...
class EntrarWidget extends StatefulWidget {
  const EntrarWidget({Key? key}) : super(key: key);
...
class _EntrarWidgetState extends State<EntrarWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Entrar'});
                                                ...
                                                children: [
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: FFButtonWidget(
                                                      onPressed: () async {
                                                        logFirebaseEvent(
                                                            'ENTRAR_PAGE_Button-Login_ON_TAP');
                                                        GoRouter.of(context)
                                                            .prepareAuthEvent();
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: FFButtonWidget(
                                                      onPressed: () async {
                                                        logFirebaseEvent(
                                                            'ENTRAR_PAGE_Button-ForgotPassword_ON_TAP');
                                                                        ...
                                                                        await showDialog(
                                                                          ...
                                                                          builder:
                                                                            ...
                                                                            return AlertDialog(
                                                                              ...
                                                                              content: Text('Não identificamos esse CPF em nosso sistema.'),
                                                                              actions: [
                                                                                TextButton(
                                                                    ...
                                                                    await showDialog(
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        return AlertDialog(
                                                                          ...
                                                                          content:
                                                                              Text('Você precisa aceitar nossas políticas de privacidade.'),
                                                                          actions: [
                                                                            TextButton(
                                                                              onPressed: () => Navigator.pop(alertDialogContext),
                                                                              child: Text('OK'),
                                                                ...
                                                                recognizer:
                                                                    TapGestureRecognizer()
                                                                      ..onTap =
                                                                          () async {
                                                                        logFirebaseEvent(
                                                                            'ENTRAR_PAGE_RichTextSpan_tbbg5qkm_ON_TAP');
                                                                          ...
                                                                          builder:
                                                                            ...
                                                                            return GestureDetector(
                                                                              ...
                                                                              child: Padding(
                                                                                ...
                                                                                child: Container(
                                                                                  height: 750.0,
                                                                                  child: PoliticaprivacidadesheetWidget(),
                                                                                ),
                                                                              ),
                                                                            );
                                                                          },
