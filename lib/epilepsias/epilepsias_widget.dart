...
import '/components/sindormessheet_widget.dart';
...
import 'epilepsias_model.dart';
export 'epilepsias_model.dart';

class EpilepsiasWidget extends StatefulWidget {
  const EpilepsiasWidget({Key? key}) : super(key: key);

  @override
  _EpilepsiasWidgetState createState() => _EpilepsiasWidgetState();
}

class _EpilepsiasWidgetState extends State<EpilepsiasWidget>
    with TickerProviderStateMixin {
  late EpilepsiasModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EpilepsiasModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Epilepsias'});
                                  ...
                                  child: Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'EPILEPSIAS_PAGE_Row_kr4vuxjn_ON_TAP');
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'EPILEPSIAS_PAGE_Icon_4m2t1uxt_ON_TAP');
                                                ...
                                                children: [
                                                  Container(
                                                    ...
                                                    child: InkWell(
                                                      ...
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'EPILEPSIAS_PAGE_Card_tfy3qrup_ON_TAP');
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    InkWell(
                                                      ...
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'EPILEPSIAS_PAGE_Icon_unjpb5o7_ON_TAP');
                                                  ...
                                                  children: [
                                                            ...
                                                            child: badges.Badge(
                                                              ...
                                                              child:
                                                                ...
                                                                onPressed:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'EPILEPSIAS_notifications_none_ICN_ON_TAP');
                                                                  scaffoldKey
                                                                      .currentState!
                                                                      .openEndDrawer();
                                                                },
                                                    ...
                                                    Container(
                                                      ...
                                                      child: InkWell(
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'EPILEPSIAS_PAGE_Card_w8hoda8g_ON_TAP');
                                                          await showModalBottomSheet(
                                                            isScrollControlled:
                                                                true,
                                                            backgroundColor:
                              ...
                              child: Container(
                                ...
                                child: Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 15.0, 0.0, 0.0),
                                  child: StreamBuilder<
                                      List<SindromesepilpticasRecord>>(
                                    stream: querySindromesepilpticasRecord(
                                      queryBuilder:
                                          (sindromesepilpticasRecord) =>
                                              sindromesepilpticasRecord.orderBy(
                                                  'titulo',
                                                  descending: true),
                                    ),
                                    builder: (context, snapshot) {
                                      ...
                                      List<SindromesepilpticasRecord>
                                          columnSindromesepilpticasRecordList =
                                          snapshot.data!;
                                      return SingleChildScrollView(
                                        child: Column(
                                          ...
                                          children: List.generate(
                                              columnSindromesepilpticasRecordList
                                                  .length, (columnIndex) {
                                            final columnSindromesepilpticasRecord =
                                                columnSindromesepilpticasRecordList[
                                                    columnIndex];
                                            return Visibility(
                                              visible: functions.showSearchResult(
                                                  ...
                                                  columnSindromesepilpticasRecord
                                                      .titulo),
                                              child: Padding(
                                                padding: EdgeInsetsDirectional
                                                    .fromSTEB(
                                                ...
                                                child: InkWell(
                                                  ...
                                                  onTap: () async {
                                                    logFirebaseEvent(
                                                        'EPILEPSIAS_Container_2mdnqrs9_ON_TAP');
                                                    await showModalBottomSheet(
