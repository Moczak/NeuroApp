...
import 'addlead_model.dart';
export 'addlead_model.dart';

class AddleadWidget extends StatefulWidget {
  const AddleadWidget({Key? key}) : super(key: key);

  @override
  _AddleadWidgetState createState() => _AddleadWidgetState();
}

class _AddleadWidgetState extends State<AddleadWidget>
    with TickerProviderStateMixin {
  late AddleadModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddleadModel());
    ...
    _model.atuacaoController ??= TextEditingController();
    _model.nomeclinicaController ??= TextEditingController();
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                FlutterFlowIconButton(
                                  ...
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'ADDLEAD_COMP_close_rounded_ICN_ON_TAP');
                            ...
                            child: SingleChildScrollView(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Expanded(
                                          child: TextFormField(
                                            controller: _model.dddController,
                                            obscureText: false,
                                            decoration: InputDecoration(
                                              labelText: 'DDD',
                                              labelStyle: FlutterFlowTheme.of(
                                  ...
                                  if (_model.tipodeclienteValue == 'Paciente')
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          20.0, 0.0, 20.0, 10.0),
                                      child: Row(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'ADDLEAD_COMP_CRIAR_BTN_ON_TAP');

                                      final leadsCreateData =
                                          createLeadsRecordData(
                                        data: getCurrentTimestamp,
                                        nome: _model.nomeController.text,
                                        telefone:
                                            '${_model.dddController.text}${_model.telController.text}',
                                        email: _model.emailController.text,
                                        endereco:
                                            _model.enderecoController.text,
                                        categoria: _model.tipodeclienteValue,
                                        nomedopai:
                                        ...
                                        idadefilho: _model.idadeController.text,
                                        status: 'PROSPECÇÃO',
                                        areadeatuacao:
                                            _model.atuacaoController.text,
                                        nomeclinica:
                                            _model.nomeclinicaController.text,
                                        obs: _model.obsController.text,
                                        sobrenome:
                                            _model.sobrenomeController.text,
                                      );
                                      await LeadsRecord.createDoc(
