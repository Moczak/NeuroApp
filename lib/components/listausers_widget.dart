...
import 'listausers_model.dart';
export 'listausers_model.dart';
...
class ListausersWidget extends StatefulWidget {
  ...
  @override
  _ListausersWidgetState createState() => _ListausersWidgetState();
}
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  FlutterFlowIconButton(
                                    ...
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'LISTAUSERS_COMP_close_rounded_ICN_ON_TAP');
                                  ...
                                  Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: FutureBuilder<List<UsersRecord>>(
                                        future: _model.useuarios(
                                          requestFn: () => queryUsersRecordOnce(
                                            queryBuilder: (usersRecord) =>
                                                usersRecord
                                                    .where('aceitoucomunidade',
                                                        isEqualTo: true)
                                                    .where('email',
                                                        isNotEqualTo:
                                                            currentUserEmail),
                                              ...
                                              return Visibility(
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'LISTAUSERS_Container_qolqlw4i_ON_TAP');
                                                                  ...
                                                                  Padding(
                                                                    padding: EdgeInsetsDirectional
                                                                        .fromSTEB(
                                                                            ...
                                                                            0.0),
                                                                    child: Text(
                                                                      '${listViewUsersRecord.displayName} ${listViewUsersRecord.sobrenome}',
                                ...
                                Expanded(
                                  child: Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        16.0, 10.0, 16.0, 10.0),
                                    child: TextFormField(
                                      controller: _model.pesquisarController,
