                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                FlutterFlowIconButton(
                                  ...
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'CRIAR_POST_COMP_close_rounded_ICN_ON_TAP');
                                                    ...
                                                    children: [
                                                      ...
                                                      if (!functions
                                                        ...
                                                        InkWell(
                                                          ...
                                                          onTap: () async {
                                                            logFirebaseEvent(
                                                                'CRIAR_POST_Container_yno6ljay_ON_TAP');
                                                            final selectedMedia =
                                                                await selectMedia(
                                                              includeBlurHash:
                                                                  true,
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    InkWell(
                                                      ...
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'CRIAR_POST_COMP_Icon_cksc1m7a_ON_TAP');
                                                        setState(() {
                                                          _model.isDataUploading =
                                                              false;
                                                          _model.uploadedLocalFile =
                                ...
                                Expanded(
                                  child: Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'CRIAR_POST_COMP_POSTAR_BTN_ON_TAP');
                                        if (_model.switchListTileValue!) {
                                          final postagensCreateData1 =
                                              createPostagensRecordData(
                                          ...
                                          await PostagensRecord.collection
                                              .doc()
                                              .set(postagensCreateData1);
                                          Navigator.pop(context);
