...
class PessoasqueresidemModel extends FlutterFlowModel {
  ...
  // State field(s) for parentesco widget.
  TextEditingController? parentescoController;
  String? Function(BuildContext, String?)? parentescoControllerValidator;
