...
import 'editaruser_model.dart';
export 'editaruser_model.dart';

class EditaruserWidget extends StatefulWidget {
  const EditaruserWidget({
    Key? key,
    this.userrefeditar,
  }) : super(key: key);

  final DocumentReference? userrefeditar;
...
class _EditaruserWidgetState extends State<EditaruserWidget>
  ...
  void initState() {
    ...
    _model.profController ??= TextEditingController(
    ...
    _model.enderecoController ??= TextEditingController(
        text: valueOrDefault<String>(
      valueOrDefault(currentUserDocument?.endereco, ''),
      'Endereço...',
    ));
    setupAnimations(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  FlutterFlowIconButton(
                                    ...
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'EDITARUSER_COMP_close_rounded_ICN_ON_TAP');
                                    ...
                                    Align(
                                      ...
                                      child: Container(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'EDITARUSER_COMP_Column_ey234jss_ON_TAP');
                                            final selectedMedia =
                                                await selectMedia(
                                              maxWidth: 800.00,
                                              maxHeight: 450.00,
                                            ...
                                            final usersUpdateData =
                                              ...
                                              logotipo: _model.uploadedFileUrl1,
                                            );
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          logFirebaseEvent(
                                              'EDITARUSER_COMP_CARREGAR_FOTO_BTN_ON_TAP');
                                          final selectedMedia =
                                              await selectMedia(
                                            includeBlurHash: true,
                                            mediaSource:
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: AuthUserStreamWidget(
                                  builder: (context) => TextFormField(
                                    controller: _model.profController,
                                    obscureText: false,
                                    decoration: InputDecoration(
                                    ...
                                    validator: _model.profControllerValidator
                                        .asValidator(context),
                                  ),
                                ),
                              ),
                                      ...
                                      child: AuthUserStreamWidget(
                                        builder: (context) => TextFormField(
                                          ...
                                          validator: _model
                                              ...
                                              .asValidator(context),
                                          inputFormatters: [_model.telMask],
                                        ),
                                      ),
                                    ),
                                  ),
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'EDITARUSER_COMP_SALVAR_BTN_ON_TAP');
                                        ...
                                        final usersUpdateData =
                                          ...
                                          profissao: _model.profController.text,
                                          sobrenome:
                                              _model.sOBREnomeController.text,
                                        );
                                        await widget.userrefeditar!
                                            .update(usersUpdateData);
                                        Navigator.pop(context);
                                        ScaffoldMessenger.of(context)
                                            .showSnackBar(
