...
import 'editar_instrumento_model.dart';
export 'editar_instrumento_model.dart';

class EditarInstrumentoWidget extends StatefulWidget {
  const EditarInstrumentoWidget({
    Key? key,
    this.pacienteref,
    this.instrumentoref,
  }) : super(key: key);
  ...
  final DocumentReference? instrumentoref;

  @override
  _EditarInstrumentoWidgetState createState() =>
      _EditarInstrumentoWidgetState();
}

class _EditarInstrumentoWidgetState extends State<EditarInstrumentoWidget>
    with TickerProviderStateMixin {
  late EditarInstrumentoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditarInstrumentoModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'EditarInstrumento'});
    setupAnimations(
                                  ...
                                  child: Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'EDITAR_INSTRUMENTO_Row_qm4qvv5k_ON_TAP');
                                                  ...
                                                  Row(
                                                    ...
                                                    children: [
                                                      InkWell(
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'EDITAR_INSTRUMENTO_Icon_71fmbdfo_ON_TAP');
                                                          context.safePop();
                                                        },
                                                        child: Icon(
                                                          Icons
                                                        ...
                                                        padding:
                                                            EdgeInsetsDirectional
                                                                .fromSTEB(
                                                                    ...
                                                                    0.0),
                                                        child: Text(
                                                          'Paciente: ${columnPacienteRecord.nome} ${columnPacienteRecord.sobrenome}',
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                              .displaySmall
                                                              .override(
                                                    ...
                                                    children: [
                                                      Container(
                                                        ...
                                                        child: InkWell(
                                                          ...
                                                          onTap: () async {
                                                            logFirebaseEvent(
                                                                'EDITAR_INSTRUMENTO_Card_1fnmhw9d_ON_TAP');
                                                    ...
                                                    Row(
                                                      ...
                                                      children: [
                                                        InkWell(
                                                          ...
                                                          onTap: () async {
                                                            logFirebaseEvent(
                                                                'EDITAR_INSTRUMENTO_Icon_joi9hw2m_ON_TAP');
                                                            context.safePop();
                                                          },
                                                          child: Icon(
                                                            Icons
                                                      ...
                                                      children: [
                                                                ...
                                                                child: badges
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    onPressed:
                                                                        () async {
                                                                      logFirebaseEvent(
                                                                          'EDITAR_INSTRUMENTO_notifications_none_IC');
                                                                      scaffoldKey
                                                                          .currentState!
                                                                          .openEndDrawer();
                                                                    },
                                                        ...
                                                        Container(
                                                          ...
                                                          child: InkWell(
                                                            ...
                                                            onTap: () async {
                                                              logFirebaseEvent(
                                                                  'EDITAR_INSTRUMENTO_Card_bexowyk3_ON_TAP');
                                                              await showModalBottomSheet(
                                                                isScrollControlled:
                                                                    true,
                                                                backgroundColor:
                              ...
                              child: Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    mainAxisSize: MainAxisSize.max,
                                    children: [
                                      StreamBuilder<InstrumentoRecord>(
                                        stream: InstrumentoRecord.getDocument(
                                            widget.instrumentoref!),
                                        builder: (context, snapshot) {
                                          // Customize what your widget looks like when it's loading.
                                          if (!snapshot.hasData) {
                                            return Center(
                                            ...
                                            children: [
                                              ...
                                              Padding(
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    Text(
                                                      'Resultado da Avaliação do Instrumento',
                                                      textAlign:
                                                          TextAlign.center,
                                                      style:
                                                          FlutterFlowTheme.of(
                                                      ...
                                                      child: Container(
                                                        ...
                                                        child: custom_widgets
                                                          ...
                                                          height: MediaQuery.of(
                                                              ...
                                                              1.0,
                                                          currentHtml:
                                                              columnInstrumentoRecord
                                                                  .resultado,
                                                          pacienteId: widget
                                                              .pacienteref?.id,
                                                          instrumentoId: widget
                                                              .instrumentoref
                                                              ?.id,
                                                        ),
                                                      ),
