...
class VerContrato2Model extends FlutterFlowModel {
  ...
  // Stores action output result for [Backend Call - API (APITEMPLATECONTRATO)] action in Button widget.
  ApiCallResponse? apiResultkti;
