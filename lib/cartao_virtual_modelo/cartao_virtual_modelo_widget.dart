...
import 'cartao_virtual_modelo_model.dart';
export 'cartao_virtual_modelo_model.dart';

class CartaoVirtualModeloWidget extends StatefulWidget {
  const CartaoVirtualModeloWidget({Key? key}) : super(key: key);

  @override
  _CartaoVirtualModeloWidgetState createState() =>
      _CartaoVirtualModeloWidgetState();
}

class _CartaoVirtualModeloWidgetState extends State<CartaoVirtualModeloWidget> {
  late CartaoVirtualModeloModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CartaoVirtualModeloModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'CartaoVirtualModelo'});
                                  ...
                                  child: Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'CARTAO_VIRTUAL_MODELO_Row_zix2ok7x_ON_TA');
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'CARTAO_VIRTUAL_MODELO_Icon_ldc7h26b_ON_T');
                                                ...
                                                children: [
                                                  Container(
                                                    ...
                                                    child: InkWell(
                                                      ...
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'CARTAO_VIRTUAL_MODELO_Card_24sb8nkx_ON_T');
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    InkWell(
                                                      ...
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'CARTAO_VIRTUAL_MODELO_Icon_d6mt3kl7_ON_T');
                                                  ...
                                                  children: [
                                                            ...
                                                            child: badges.Badge(
                                                              ...
                                                              child:
                                                                ...
                                                                onPressed:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'CARTAO_VIRTUAL_MODELO_notifications_none');
                                                                  scaffoldKey
                                                                      .currentState!
                                                                      .openEndDrawer();
                                                                },
                                                    ...
                                                    Container(
                                                      ...
                                                      child: InkWell(
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'CARTAO_VIRTUAL_MODELO_Card_b8f6em77_ON_T');
                                                          await showModalBottomSheet(
                                                            isScrollControlled:
                                                                true,
                                                            backgroundColor:
                                                      ...
                                                      children: [
                                                        Padding(
                                                          ...
                                                          child: InkWell(
                                                            ...
                                                            onTap: () async {
                                                              logFirebaseEvent(
                                                                  'CARTAO_VIRTUAL_MODELO_Container_jpqgqo59');

                                                              context.goNamed(
                                                                'CartaoVirtualModelo01',
                                                                extra: <String,
                                                                    dynamic>{
                                                                  kTransitionInfoKey:
                                                                      TransitionInfo(
                                                      ...
                                                      children: [
                                                        Padding(
                                                          ...
                                                          child: InkWell(
                                                            ...
                                                            onTap: () async {
                                                              logFirebaseEvent(
                                                                  'CARTAO_VIRTUAL_MODELO_Container_rt8ksz3i');

                                                              context.goNamed(
                                                                'CartaoVirtualModelo02',
                                                                extra: <String,
                                                                    dynamic>{
                                                                  kTransitionInfoKey:
                                                                      TransitionInfo(
                                                      ...
                                                      children: [
                                                        Padding(
                                                          ...
                                                          child: InkWell(
                                                            ...
                                                            onTap: () async {
                                                              logFirebaseEvent(
                                                                  'CARTAO_VIRTUAL_MODELO_Container_2vtigtps');
