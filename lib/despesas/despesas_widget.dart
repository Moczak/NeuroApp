...
class DespesasWidget extends StatefulWidget {
  ...
  @override
  _DespesasWidgetState createState() => _DespesasWidgetState();
}
...
class _DespesasWidgetState extends State<DespesasWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Despesas'});
                                  ...
                                  child: Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'DESPESAS_PAGE_Row_qxc3nm2v_ON_TAP');
                                                    ...
                                                    children: [
                                                      Padding(
                                                        ...
                                                        child: InkWell(
                                                          ...
                                                          onTap: () async {
                                                            logFirebaseEvent(
                                                                'DESPESAS_PAGE_Icon_mjpem2fl_ON_TAP');
                                              ...
                                              return Container(
                                                ...
                                                child: badges.Badge(
                                                  ...
                                                  child: FlutterFlowIconButton(
                                                    ...
                                                    onPressed: () async {
                                                      logFirebaseEvent(
                                                          'DESPESAS_notifications_none_ICN_ON_TAP');
                                          ...
                                          children: [
                                            Container(
                                              ...
                                              child: InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'DESPESAS_PAGE_Card_7rjnkh0w_ON_TAP');
                                                      ...
                                                      children: [
                                                        Padding(
                                                          ...
                                                          child: InkWell(
                                                            ...
                                                            onTap: () async {
                                                              logFirebaseEvent(
                                                                  'DESPESAS_PAGE_Icon_cf7sva7u_ON_TAP');
                                                  ...
                                                  children: [
                                                    ...
                                                    Container(
                                                      ...
                                                      child: InkWell(
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'DESPESAS_PAGE_Card_font1flo_ON_TAP');
                                                          await showModalBottomSheet(
                                                            isScrollControlled:
                                                                true,
                                                            backgroundColor:
                            ...
                            child: Column(
                              ...
                              children: [
                                                        ...
                                                        children: [
                                                          Padding(
                                                            ...
                                                            child: Text(
                                                              valueOrDefault<
                                                                  String>(
                                                                'R\$ ${functions.somaLista(cardDespesasRecordList.map((e) => e.valorInt).withoutNulls.toList()).toString()},00',
                                                                'R\$ 00,00',
                                                              ),
                                                              style: FlutterFlowTheme
                                                                      .of(context)
                                ...
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      16.0, 0.0, 16.0, 0.0),
                                  child: StreamBuilder<List<DespesasRecord>>(
                                    stream: queryDespesasRecord(
                                      parent: currentUserReference,
                                      queryBuilder: (despesasRecord) =>
                                          despesasRecord.orderBy('titulo'),
                                    ),
                                    builder: (context, snapshot) {
                                      // Customize what your widget looks like when it's loading.
                                      if (!snapshot.hasData) {
                                      ...
                                      return ListView.builder(
                                        ...
                                        scrollDirection: Axis.vertical,
                                        itemCount:
                                            listViewDespesasRecordList.length,
                                        itemBuilder: (context, listViewIndex) {
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      onTap:
                                                                          () async {
                                                                        logFirebaseEvent(
                                                                            'DESPESAS_PAGE_Text_gjkyaaut_ON_TAP');
                                                                        await showModalBottomSheet(
                                                                          isScrollControlled:
                                                                              true,
                                                                          backgroundColor:
                                                                          ...
                                                                          builder:
                                                                            ...
                                                                            return GestureDetector(
                                                                              ...
                                                                              child: Padding(
                                                                                ...
                                                                                child: CriardespesaeditaWidget(
                                                                                  referenciadespesa: listViewDespesasRecord.reference,
                                                                                ),
                                                                              ),
                                                                            );
                                                                          },
                                                              ...
                                                              children: [
                                                                InkWell(
                                                                  ...
                                                                  onTap:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'DESPESAS_PAGE_Icon_bjkzpj34_ON_TAP');
                                ...
                                child: Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'DESPESAS_PAGE_Icon_9bx8kx8z_ON_TAP');
                                        await showModalBottomSheet(
                                          isScrollControlled: true,
