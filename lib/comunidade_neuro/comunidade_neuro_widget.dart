...
import 'comunidade_neuro_model.dart';
export 'comunidade_neuro_model.dart';

class ComunidadeNeuroWidget extends StatefulWidget {
  const ComunidadeNeuroWidget({Key? key}) : super(key: key);

  @override
  _ComunidadeNeuroWidgetState createState() => _ComunidadeNeuroWidgetState();
}

class _ComunidadeNeuroWidgetState extends State<ComunidadeNeuroWidget> {
  late ComunidadeNeuroModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ComunidadeNeuroModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'ComunidadeNeuro'});
                                  ...
                                  child: Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'COMUNIDADE_NEURO_Row_lzcgp1uk_ON_TAP');
                                                ...
                                                children: [
                                                  Container(
                                                    ...
                                                    child: InkWell(
                                                      ...
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'COMUNIDADE_NEURO_Card_9jg4z28u_ON_TAP');
                                                  ...
                                                  children: [
                                                            ...
                                                            child: badges.Badge(
                                                              ...
                                                              child:
                                                                ...
                                                                onPressed:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'COMUNIDADE_NEURO_notifications_none_ICN_');
                                                                  scaffoldKey
                                                                      .currentState!
                                                                      .openEndDrawer();
                                                                },
                                                    ...
                                                    Container(
                                                      ...
                                                      child: InkWell(
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'COMUNIDADE_NEURO_Card_spxyexea_ON_TAP');
                                                          await showModalBottomSheet(
                                                            isScrollControlled:
                                                                true,
                                                            backgroundColor:
                                              ...
                                              child: RichText(
                                                text: TextSpan(
                                                  children: [
                                                    ...
                                                    TextSpan(
                                                      text:
                                                          ' Partilhar conhecimento em comunidade é a ponte que conecta profissionais com diferentes habilidades e experiências, tornando o aprendizado colaborativo e o suporte mútuo possível, criando uma rede de apoio chamada ',
                                                      style: TextStyle(),
                                                    ),
                                                    TextSpan(
                                                      text: 'COMUNIDADE NEURO!',
                                                ...
                                                child: RichText(
                                                  text: TextSpan(
                                                    children: [
                                                      TextSpan(
                                                        text:
                                                            'Na comunidade, a participação ativa e colaborativa pode ser recompensada com o ',
                                                        style: TextStyle(),
                                                      ),
                                                      TextSpan(
                                                        text:
                                                            'Crescimento em Níveis, ',
                                                        style: TextStyle(
                                                          color: FlutterFlowTheme
                                                                  .of(context)
                                                              .alternate,
                                                      ...
                                                      TextSpan(
                                                        text:
                                                            'quanto mais você compartilha e interage com os outros nas postagens o seu nível aumenta, conforme abaixo:',
                                                        style: TextStyle(),
                                                      )
                                                    ],
                                                    style: FlutterFlowTheme.of(
                                                ...
                                                children: [
                                                  Padding(
                                                    ...
                                                    child: Row(
                                                      ...
                                                      children: [
                                                        Text(
                                                          'Selecione abaixo as informações que gostaria que seja visíveis em seu perfil',
                                                          textAlign:
                                                              TextAlign.center,
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: FFButtonWidget(
                                                            onPressed:
                                                                () async {
                                                              logFirebaseEvent(
                                                                  'COMUNIDADE_NEURO_PARTICIPAR_DA_CONEXÃO_B');
