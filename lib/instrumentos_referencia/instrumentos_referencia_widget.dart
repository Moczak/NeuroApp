...
import 'instrumentos_referencia_model.dart';
export 'instrumentos_referencia_model.dart';

class InstrumentosReferenciaWidget extends StatefulWidget {
  const InstrumentosReferenciaWidget({Key? key}) : super(key: key);

  @override
  _InstrumentosReferenciaWidgetState createState() =>
      _InstrumentosReferenciaWidgetState();
}

class _InstrumentosReferenciaWidgetState
    extends State<InstrumentosReferenciaWidget> with TickerProviderStateMixin {
  late InstrumentosReferenciaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InstrumentosReferenciaModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'InstrumentosReferencia'});
    setupAnimations(
                                  ...
                                  child: Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'INSTRUMENTOS_REFERENCIA_Row_f1z36h8t_ON_');
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'INSTRUMENTOS_REFERENCIA_Icon_2p4rdsm6_ON');
                                                      context.safePop();
                                                    },
                                                    child: Icon(
                                                ...
                                                children: [
                                                  Container(
                                                    ...
                                                    child: InkWell(
                                                      ...
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'INSTRUMENTOS_REFERENCIA_Card_h6gxm4lf_ON');
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    InkWell(
                                                      ...
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'INSTRUMENTOS_REFERENCIA_Icon_zdli7ut3_ON');
                                                        context.safePop();
                                                      },
                                                      child: Icon(
                                                        Icons
                                                  ...
                                                  children: [
                                                            ...
                                                            child: badges.Badge(
                                                              ...
                                                              child:
                                                                ...
                                                                onPressed:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'INSTRUMENTOS_REFERENCIA_notifications_no');
                                                                  scaffoldKey
                                                                      .currentState!
                                                                      .openEndDrawer();
                                                                },
                                                    ...
                                                    Container(
                                                      ...
                                                      child: InkWell(
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'INSTRUMENTOS_REFERENCIA_Card_g4adrkup_ON');
                                                          await showModalBottomSheet(
                                                            isScrollControlled:
                                                                true,
                                                            backgroundColor:
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: FutureBuilder<
                                                        List<
                                                            InstrumentosRecord>>(
                                                      future:
                                                          queryInstrumentosRecordOnce(
                                                        queryBuilder:
                                                            (instrumentosRecord) =>
                                                                instrumentosRecord.where(
                                                                    'categoria',
                                                                    isEqualTo:
                                                                        'Atenção e Memória'),
                                                      ),
                                                      builder:
                                                        ...
                                                        List<InstrumentosRecord>
                                                            listViewInstrumentosRecordList =
                                                            snapshot.data!;
                                                        return ListView.builder(
                                                          padding:
                                                              EdgeInsets.zero,
                                                          ...
                                                          itemBuilder: (context,
                                                              listViewIndex) {
                                                            final listViewInstrumentosRecord =
                                                                listViewInstrumentosRecordList[
                                                                    listViewIndex];
                                                            return Align(
                                                              alignment:
                                                              ...
                                                              child: Padding(
                                                                ...
                                                                child: InkWell(
                                                                  ...
                                                                  onTap:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'INSTRUMENTOS_REFERENCIA_materialCard_2_O');
                                                                    await showModalBottomSheet(
                                                                      isScrollControlled:
                                                                          true,
                                                                      backgroundColor:
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        return GestureDetector(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                                VerinstrumentoWidget(
                                                                              refinstrumento: listViewInstrumentosRecord.reference,
                                                                            ),
                                                                          ),
                                                                        );
                                                                      },
                                                                          ...
                                                                          Expanded(
                                                                            child:
                                                                              ...
                                                                              child: Column(
                                                                                ...
                                                                                children: [
                                                                                  Text(
                                                                                    listViewInstrumentosRecord.nome!,
                                                                                  ...
                                                                                  Padding(
                                                                                    ...
                                                                                    child: Text(
                                                                                      listViewInstrumentosRecord.faixaetriaindicada!,
                                                                      ...
                                                                      return GestureDetector(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                              VerinstrumentoWidget(
                                                                            refinstrumento:
                                                                                listViewInstrumentosRecord.reference,
                                                                          ),
                                                                        ),
                                                                      );
                                                                    },
