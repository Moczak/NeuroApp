...
import 'ver_anamnese_model.dart';
export 'ver_anamnese_model.dart';

class VerAnamneseWidget extends StatefulWidget {
  const VerAnamneseWidget({
    Key? key,
    this.pacienteparametro,
    this.anamneseparametro,
  }) : super(key: key);

  final DocumentReference? pacienteparametro;
  final DocumentReference? anamneseparametro;

  @override
  _VerAnamneseWidgetState createState() => _VerAnamneseWidgetState();
}

class _VerAnamneseWidgetState extends State<VerAnamneseWidget>
    with TickerProviderStateMixin {
  late VerAnamneseModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VerAnamneseModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'VerAnamnese'});
    setupAnimations(
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<PacienteRecord>(
      stream: PacienteRecord.getDocument(widget.pacienteparametro!),
      builder: (context, snapshot) {
        ...
        final verAnamnesePacienteRecord = snapshot.data!;
                                      ...
                                      child: Container(
                                        ...
                                        child: Padding(
                                          ...
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'VER_ANAMNESE_PAGE_Row_op15xkve_ON_TAP');
                                                  ...
                                                  Row(
                                                    ...
                                                    children: [
                                                      InkWell(
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'VER_ANAMNESE_PAGE_Icon_0tdfzduk_ON_TAP');
                                                        ...
                                                        padding:
                                                            EdgeInsetsDirectional
                                                                .fromSTEB(
                                                                    ...
                                                                    0.0),
                                                        child: Text(
                                                          'Paciente: ${verAnamnesePacienteRecord.nome} ${verAnamnesePacienteRecord.sobrenome}',
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                              .displaySmall
                                                              .override(
                                                    ...
                                                    children: [
                                                      Container(
                                                        ...
                                                        child: InkWell(
                                                          ...
                                                          onTap: () async {
                                                            logFirebaseEvent(
                                                                'VER_ANAMNESE_PAGE_Card_ui0s555t_ON_TAP');
                                            ...
                                            children: [
                                              Padding(
                                                ...
                                                child: InkWell(
                                                  ...
                                                  onTap: () async {
                                                    logFirebaseEvent(
                                                        'VER_ANAMNESE_PAGE_Column_1qu8qt5y_ON_TAP');
                                                    context.pop();
                                                  },
                                                  child: Column(
                                                    mainAxisSize:
                                                      ...
                                                      Row(
                                                        ...
                                                        children: [
                                                          InkWell(
                                                            ...
                                                            onTap: () async {
                                                              logFirebaseEvent(
                                                                  'VER_ANAMNESE_PAGE_Icon_j9bv2cys_ON_TAP');
                                                              var confirmDialogResponse =
                                                                  await showDialog<
                                                                          bool>(
                                                                        context:
                                                      ...
                                                      children: [
                                                                ...
                                                                child: badges
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    onPressed:
                                                                        () async {
                                                                      logFirebaseEvent(
                                                                          'VER_ANAMNESE_notifications_none_ICN_ON_T');
                                                                      scaffoldKey
                                                                          .currentState!
                                                                          .openEndDrawer();
                                                                    },
                                                        ...
                                                        Container(
                                                          ...
                                                          child: InkWell(
                                                            ...
                                                            onTap: () async {
                                                              logFirebaseEvent(
                                                                  'VER_ANAMNESE_PAGE_Card_q31gpywa_ON_TAP');
                                                              await showModalBottomSheet(
                                                                isScrollControlled:
                                                                    true,
                                                                backgroundColor:
