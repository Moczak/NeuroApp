...
import 'escalade_c_o_n_n_e_r_spais_model.dart';
export 'escalade_c_o_n_n_e_r_spais_model.dart';

class EscaladeCONNERSpaisWidget extends StatefulWidget {
  const EscaladeCONNERSpaisWidget({
    Key? key,
    this.pacienteref,
  }) : super(key: key);
  ...
  @override
  _EscaladeCONNERSpaisWidgetState createState() =>
      _EscaladeCONNERSpaisWidgetState();
}

class _EscaladeCONNERSpaisWidgetState extends State<EscaladeCONNERSpaisWidget>
    with TickerProviderStateMixin {
  late EscaladeCONNERSpaisModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EscaladeCONNERSpaisModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'EscaladeCONNERSpais'});
    setupAnimations(
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<PacienteRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final escaladeCONNERSpaisPacienteRecord = snapshot.data!;
                                      ...
                                      child: Container(
                                        ...
                                        child: Padding(
                                          ...
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'ESCALADE_C_O_N_N_E_R_SPAIS_Row_m7o3l1s4_');
                                                      ...
                                                      Row(
                                                        ...
                                                        children: [
                                                          InkWell(
                                                            ...
                                                            onTap: () async {
                                                              logFirebaseEvent(
                                                                  'ESCALADE_C_O_N_N_E_R_SPAIS_Icon_uwj2sh4g');
                                                        ...
                                                        children: [
                                                          Container(
                                                            ...
                                                            child: InkWell(
                                                              ...
                                                              onTap: () async {
                                                                logFirebaseEvent(
                                                                    'ESCALADE_C_O_N_N_E_R_SPAIS_Card_ah9cm9qj');
                                                        ...
                                                        Row(
                                                          ...
                                                          children: [
                                                            InkWell(
                                                              ...
                                                              onTap: () async {
                                                                logFirebaseEvent(
                                                                    'ESCALADE_C_O_N_N_E_R_SPAIS_Icon_z45lo1ch');
                                                                    ...
                                                                    child: badges
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        onPressed:
                                                                            () async {
                                                                          logFirebaseEvent(
                                                                              'ESCALADE_C_O_N_N_E_R_SPAIS_notifications');
                                                                          scaffoldKey
                                                                              .currentState!
                                                                              .openEndDrawer();
                                                                        },
                                                            ...
                                                            Container(
                                                              ...
                                                              child: InkWell(
                                                                ...
                                                                onTap:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'ESCALADE_C_O_N_N_E_R_SPAIS_Card_k6bsmad2');
                                                                  await showModalBottomSheet(
                                                                    isScrollControlled:
                                                                        true,
                                                                    backgroundColor:
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'ESCALADE_C_O_N_N_E_R_SPAIS_FINALIZAR_BTN');

                                        final connersCreateData =
                                            createConnersRecordData(
                                          paciente: widget.pacienteref,
                                          data: getCurrentTimestamp,
                                          cricouparaescola: false,
                                        );
                                        var connersRecordReference =
                                            ConnersRecord.collection.doc();
                                        await connersRecordReference
                                            .set(connersCreateData);
                                        _model.criouconners =
                                            ConnersRecord.getDocumentFromData(
                                                connersCreateData,
                                                connersRecordReference);

                                        final paraPaisCreateData =
                                            createParaPaisRecordData(
                                          resultado: valueOrDefault<int>(
                                            functions.somarConnersPais(
                                                _model.q1Value,
                                                _model.q2Value,
                                                0,
                                                _model.q3Value,
                                        ...
                                        await ParaPaisRecord.createDoc(
                                                _model.criouconners!.reference)
                                            .set(paraPaisCreateData);
