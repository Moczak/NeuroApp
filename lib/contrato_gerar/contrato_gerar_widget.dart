...
import 'contrato_gerar_model.dart';
export 'contrato_gerar_model.dart';

class ContratoGerarWidget extends StatefulWidget {
  const ContratoGerarWidget({
    Key? key,
  ...
  @override
  _ContratoGerarWidgetState createState() => _ContratoGerarWidgetState();
}

class _ContratoGerarWidgetState extends State<ContratoGerarWidget>
    with TickerProviderStateMixin {
  late ContratoGerarModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ContratoGerarModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'ContratoGerar'});
    _model.cabecalhoController ??= TextEditingController();
    ...
    _model.cprimeiraController ??= TextEditingController(
        text: functions.evitarQbradeLinha(
    ...
    _model.csegundaController ??= TextEditingController(
        text: functions.evitarQbradeLinha(
    ...
    _model.cterceiraController ??= TextEditingController();
    _model.cquartaController ??= TextEditingController();
    setupAnimations(
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<PacienteRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final contratoGerarPacienteRecord = snapshot.data!;
                                      ...
                                      child: Container(
                                        ...
                                        child: Padding(
                                          ...
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'CONTRATO_GERAR_PAGE_Row_3tdvu3d8_ON_TAP');
                                                  ...
                                                  Row(
                                                    ...
                                                    children: [
                                                      InkWell(
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'CONTRATO_GERAR_PAGE_Icon_lisz4f6y_ON_TAP');
                                                        ...
                                                        padding:
                                                            EdgeInsetsDirectional
                                                                .fromSTEB(
                                                                    ...
                                                                    0.0),
                                                        child: Text(
                                                          'Paciente: ${contratoGerarPacienteRecord.nome} ${contratoGerarPacienteRecord.sobrenome}',
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                              .displaySmall
                                                              .override(
                                                    ...
                                                    children: [
                                                      Container(
                                                        ...
                                                        child: InkWell(
                                                          ...
                                                          onTap: () async {
                                                            logFirebaseEvent(
                                                                'CONTRATO_GERAR_PAGE_Card_45xd8iid_ON_TAP');
                                                    ...
                                                    Row(
                                                      ...
                                                      children: [
                                                        InkWell(
                                                          ...
                                                          onTap: () async {
                                                            logFirebaseEvent(
                                                                'CONTRATO_GERAR_PAGE_Icon_avzzm0ef_ON_TAP');
                                                      ...
                                                      children: [
                                                                ...
                                                                child: badges
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    onPressed:
                                                                        () async {
                                                                      logFirebaseEvent(
                                                                          'CONTRATO_GERAR_notifications_none_ICN_ON');
                                                                      scaffoldKey
                                                                          .currentState!
                                                                          .openEndDrawer();
                                                                    },
                                                        ...
                                                        Container(
                                                          ...
                                                          child: InkWell(
                                                            ...
                                                            onTap: () async {
                                                              logFirebaseEvent(
                                                                  'CONTRATO_GERAR_PAGE_Card_v08k6f6b_ON_TAP');
                                                              await showModalBottomSheet(
                                                                isScrollControlled:
                                                                    true,
                                                                backgroundColor:
                                                                                    ...
                                                                                    child: Padding(
                                                                                      ...
                                                                                      child: Text(
                                                                                        valueOrDefault<String>(
                                                                                          '${contratoGerarPacienteRecord.nome} ${contratoGerarPacienteRecord.sobrenome}',
                                                                                          'Nome',
                                                                                        ),
                                                                                        textAlign: TextAlign.start,
                                                                                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                ...
                                                                                children: [
                                                                                  ...
                                                                                  Expanded(
                                                                                    child: Padding(
                                                                                      ...
                                                                                      child: Text(
                                                                                        valueOrDefault<String>(
                                                                                          contratoGerarPacienteRecord.datadenascimento,
                                                                                          'Data de Nascimento',
                                                                                        ),
                                                                                        textAlign: TextAlign.start,
                                                                                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                ...
                                                                                children: [
                                                                                  ...
                                                                                  Expanded(
                                                                                    child: Padding(
                                                                                      ...
                                                                                      child: Text(
                                                                                        valueOrDefault<String>(
                                                                                          contratoGerarPacienteRecord.nomedaescola,
                                                                                          'Escola',
                                                                                        ),
                                                                                        textAlign: TextAlign.start,
                                                                                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                ...
                                                                                children: [
                                                                                  ...
                                                                                  Expanded(
                                                                                    child: Padding(
                                                                                      ...
                                                                                      child: Text(
                                                                                        valueOrDefault<String>(
                                                                                          contratoGerarPacienteRecord.nomedopai,
                                                                                          'Pai',
                                                                                        ),
                                                                                        textAlign: TextAlign.start,
                                                                                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                ...
                                                                                children: [
                                                                                  ...
                                                                                  Expanded(
                                                                                    child: Padding(
                                                                                      ...
                                                                                      child: Text(
                                                                                        valueOrDefault<String>(
                                                                                          contratoGerarPacienteRecord.nomedamae,
                                                                                          'Mãe',
                                                                                        ),
                                                                                        textAlign: TextAlign.start,
                                                                                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'CONTRATO_GERAR_GERAR_CONTRATO_BTN_ON_TAP');

                                      final contratoCreateData =
                                          createContratoRecordData(
                                        cabecalho:
                                            _model.cabecalhoController.text,
                                        cprimeira: functions.evitarQbradeLinha(
                                            _model.cprimeiraController.text),
                                        csegunda: functions.evitarQbradeLinha(
                                            _model.csegundaController.text),
                                        cterceira: functions.evitarQbradeLinha(
                                            _model.cterceiraController.text),
                                        cquarta: functions.evitarQbradeLinha(
                                            _model.cquartaController.text),
                                        logourl: valueOrDefault(
                                            currentUserDocument?.logotipo, ''),
                                        tel: _model.telController.text,
                                        email: _model.emailController.text,
                                        endereco:
                                            _model.enderecoController.text,
                                        contratogerado: false,
                                        datacontratostring: dateTimeFormat(
                                          'd/M/y',
                                          getCurrentTimestamp,
                                      ...
                                      var contratoRecordReference =
                                          ContratoRecord.createDoc(
                                              widget.pacienterefcontrato!);
                                      await contratoRecordReference
                                          .set(contratoCreateData);
                                      _model.contratogerado =
                                          ContratoRecord.getDocumentFromData(
                                              contratoCreateData,
                                      ...
                                      context.goNamed(
                                        ...
                                        queryParams: {
                                          ...
                                          'refdocontrato': serializeParam(
                                            _model.contratogerado!.reference,
                                            ParamType.DocumentReference,
                                          ),
                                        }.withoutNulls,
