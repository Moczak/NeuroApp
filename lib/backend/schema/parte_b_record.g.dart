...
part of 'parte_b_record.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<ParteBRecord> _$parteBRecordSerializer =
    new _$ParteBRecordSerializer();

class _$ParteBRecordSerializer implements StructuredSerializer<ParteBRecord> {
  @override
  final Iterable<Type> types = const [ParteBRecord, _$ParteBRecord];
  @override
  final String wireName = 'ParteBRecord';

  @override
  Iterable<Object?> serialize(Serializers serializers, ParteBRecord object,
  ...
  @override
  ParteBRecord deserialize(
      Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new ParteBRecordBuilder();
...
class _$ParteBRecord extends ParteBRecord {
  @override
  final String? q1;
  @override
  final String? q2;
  ...
  factory _$ParteBRecord([void Function(ParteBRecordBuilder)? updates]) =>
      (new ParteBRecordBuilder()..update(updates))._build();
  ...
  @override
  ParteBRecord rebuild(void Function(ParteBRecordBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  ParteBRecordBuilder toBuilder() => new ParteBRecordBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is ParteBRecord &&
        q1 == other.q1 &&
        q2 == other.q2 &&
        q3 == other.q3 &&
        q4 == other.q4 &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'ParteBRecord')
          ..add('q1', q1)
          ..add('q2', q2)
          ..add('q3', q3)
          ..add('q4', q4)
...
class ParteBRecordBuilder
    implements Builder<ParteBRecord, ParteBRecordBuilder> {
  _$ParteBRecord? _$v;
  ...
  ParteBRecordBuilder() {
    ParteBRecord._initializeBuilder(this);
  }

  ParteBRecordBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _q1 = $v.q1;
      _q2 = $v.q2;
  ...
  @override
  void replace(ParteBRecord other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$ParteBRecord;
  }

  @override
  void update(void Function(ParteBRecordBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  ParteBRecord build() => _build();

  _$ParteBRecord _build() {
    final _$result = _$v ??
        new _$ParteBRecord._(
            q1: q1,
            q2: q2,
            q3: q3,
            q4: q4,
