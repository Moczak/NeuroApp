...
import 'farmacologia_model.dart';
export 'farmacologia_model.dart';

class FarmacologiaWidget extends StatefulWidget {
  const FarmacologiaWidget({Key? key}) : super(key: key);

  @override
  _FarmacologiaWidgetState createState() => _FarmacologiaWidgetState();
}

class _FarmacologiaWidgetState extends State<FarmacologiaWidget>
    with TickerProviderStateMixin {
  late FarmacologiaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FarmacologiaModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'Farmacologia'});
                                  ...
                                  child: Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'FARMACOLOGIA_PAGE_Row_99javzzr_ON_TAP');
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'FARMACOLOGIA_PAGE_Icon_xs5141jz_ON_TAP');
                                                ...
                                                children: [
                                                  Container(
                                                    ...
                                                    child: InkWell(
                                                      ...
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'FARMACOLOGIA_PAGE_Card_et4lhmcx_ON_TAP');
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    InkWell(
                                                      ...
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'FARMACOLOGIA_PAGE_Icon_qab17snj_ON_TAP');
                                                  ...
                                                  children: [
                                                            ...
                                                            child: badges.Badge(
                                                              ...
                                                              child:
                                                                ...
                                                                onPressed:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'FARMACOLOGIA_notifications_none_ICN_ON_T');
                                                                  scaffoldKey
                                                                      .currentState!
                                                                      .openEndDrawer();
                                                                },
                                                    ...
                                                    Container(
                                                      ...
                                                      child: InkWell(
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'FARMACOLOGIA_PAGE_Card_7j7fuzjy_ON_TAP');
                                                          await showModalBottomSheet(
                                                            isScrollControlled:
                                                                true,
                                                            backgroundColor:
                              ...
                              child: Container(
                                ...
                                child: Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 15.0, 0.0, 0.0),
                                  child: StreamBuilder<
                                      List<NeurofarmacologiaRecord>>(
                                    stream: queryNeurofarmacologiaRecord(
                                      queryBuilder: (neurofarmacologiaRecord) =>
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      List<NeurofarmacologiaRecord>
                                          columnNeurofarmacologiaRecordList =
                                          snapshot.data!;
                                      return SingleChildScrollView(
                                        child: Column(
                                          ...
                                          children: List.generate(
                                              columnNeurofarmacologiaRecordList
                                                  .length, (columnIndex) {
                                            final columnNeurofarmacologiaRecord =
                                                columnNeurofarmacologiaRecordList[
                                                    columnIndex];
                                            return Visibility(
                                              ...
                                              child: Padding(
                                                ...
                                                child: InkWell(
                                                  ...
                                                  onTap: () async {
                                                    logFirebaseEvent(
                                                        'FARMACOLOGIA_Container_6x0o4tzj_ON_TAP');
                                                    await showModalBottomSheet(
