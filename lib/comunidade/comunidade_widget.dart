...
import '/components/acaopost_widget.dart';
import '/components/comments_widget.dart';
import '/components/criar_post_widget.dart';
import '/components/listausers_widget.dart';
...
export 'comunidade_model.dart';

class ComunidadeWidget extends StatefulWidget {
  const ComunidadeWidget({Key? key}) : super(key: key);

  @override
  _ComunidadeWidgetState createState() => _ComunidadeWidgetState();
}

class _ComunidadeWidgetState extends State<ComunidadeWidget>
    with TickerProviderStateMixin {
  late ComunidadeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ComunidadeModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Comunidade'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('COMUNIDADE_PAGE_Comunidade_ON_INIT_STATE');
      if (valueOrDefault<bool>(currentUserDocument?.aceitoucomunidade, false)) {
        context.goNamed(
          'Comunidade',
                                  ...
                                  child: Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'COMUNIDADE_PAGE_Row_ndxulca1_ON_TAP');
                                                ...
                                                children: [
                                                  Container(
                                                    ...
                                                    child: InkWell(
                                                      ...
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'COMUNIDADE_PAGE_Card_w3g2hdcb_ON_TAP');
                                                  ...
                                                  children: [
                                                            ...
                                                            child: badges.Badge(
                                                              ...
                                                              child:
                                                                ...
                                                                onPressed:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'COMUNIDADE_notifications_none_ICN_ON_TAP');
                                                                  scaffoldKey
                                                                      .currentState!
                                                                      .openEndDrawer();
                                                                },
                                                    ...
                                                    Container(
                                                      ...
                                                      child: InkWell(
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'COMUNIDADE_PAGE_Card_dr9lsay1_ON_TAP');
                                                          await showModalBottomSheet(
                                                            isScrollControlled:
                                                                true,
                                                            backgroundColor:
                                  ...
                                  child: Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Expanded(
                                                                        child:
                                                                          ...
                                                                          onPressed:
                                                                              () async {
                                                                            logFirebaseEvent('COMUNIDADE_PAGE_PERFIL_BTN_ON_TAP');

                                                                            context.goNamed('MeuPerfilComunidade');
                                                                          },
                                                                          text:
                                                                              'Perfil',
                                                                          options:
                                                                      ...
                                                                      Padding(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onPressed:
                                                                              () async {
                                                                            logFirebaseEvent('COMUNIDADE_PAGE_person_search_ICN_ON_TAP');
                                                                            await showModalBottomSheet(
                                        ...
                                        StreamBuilder<List<PostagensRecord>>(
                                          stream: queryPostagensRecord(
                                            queryBuilder: (postagensRecord) =>
                                                postagensRecord.orderBy(
                                                    'time_posted',
                                                    descending: true),
                                            limit: 30,
                                          ),
                                                                ...
                                                                children: [
                                                                  InkWell(
                                                                    ...
                                                                    onTap:
                                                                        () async {
                                                                      logFirebaseEvent(
                                                                          'COMUNIDADE_PAGE_Row_8d3d4s6m_ON_TAP');
                                                                  ...
                                                                  FlutterFlowIconButton(
                                                                    ...
                                                                    onPressed:
                                                                        () async {
                                                                      logFirebaseEvent(
                                                                          'COMUNIDADE_keyboard_control_ICN_ON_TAP');
                                                                      await showModalBottomSheet(
                                                                        isScrollControlled:
                                                                            true,
                                                                        backgroundColor:
                                                                        ...
                                                                        builder:
                                                                          ...
                                                                          return GestureDetector(
                                                                            ...
                                                                            child:
                                                                                Padding(
                                                                              padding: MediaQuery.of(bottomSheetContext).viewInsets,
                                                                              child: AcaopostWidget(
                                                                                postref: socialFeedPostagensRecord.reference,
                                                                              ),
                                                                            ),
                                                                          );
                                                                        },
                                                                                  ...
                                                                                  if (!socialFeedPostagensRecord.likes!.toList().contains(currentUserReference))
                                                                                    Align(
                                                                                      ...
                                                                                      child: InkWell(
                                                                                        ...
                                                                                        highlightColor: Colors.transparent,
                                                                                        onTap: () async {
                                                                                          logFirebaseEvent('COMUNIDADE_PAGE_Icon_97ez9861_ON_TAP');
                                                                                          ...
                                                                                          _model.soundPlayer!.setUrl('https://firebasestorage.googleapis.com/v0/b/universoneuro-f368b.appspot.com/o/imagens%2Flike.mp3?alt=media&token=7c0423f8-8788-4634-8636-c97d9d74e239').then((_) => _model.soundPlayer!.play());
                                                                                        },
                                                                                        child: Icon(
                                                                                  ...
                                                                                  if (socialFeedPostagensRecord.likes!.toList().contains(currentUserReference))
                                                                                    Align(
                                                                                      ...
                                                                                      child: InkWell(
                                                                                        ...
                                                                                        highlightColor: Colors.transparent,
                                                                                        onTap: () async {
                                                                                          logFirebaseEvent('COMUNIDADE_PAGE_Icon_uv1jug4y_ON_TAP');
                              ...
                              child: Padding(
                                ...
                                child: Container(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'COMUNIDADE_PAGE_Icon_qjtn25bn_ON_TAP');
                                      await showModalBottomSheet(
                                        isScrollControlled: true,
                                        backgroundColor: Colors.transparent,
                                        enableDrag: false,
