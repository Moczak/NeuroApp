...
import 'escalade_c_o_n_n_e_r_sescola_model.dart';
export 'escalade_c_o_n_n_e_r_sescola_model.dart';

class EscaladeCONNERSescolaWidget extends StatefulWidget {
  const EscaladeCONNERSescolaWidget({
    Key? key,
    this.pacienteref,
    this.connersdocumentref,
  }) : super(key: key);

  final DocumentReference? pacienteref;
  final DocumentReference? connersdocumentref;

  @override
  _EscaladeCONNERSescolaWidgetState createState() =>
      _EscaladeCONNERSescolaWidgetState();
}

class _EscaladeCONNERSescolaWidgetState
    extends State<EscaladeCONNERSescolaWidget> with TickerProviderStateMixin {
  late EscaladeCONNERSescolaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EscaladeCONNERSescolaModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'EscaladeCONNERSescola'});
    setupAnimations(
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<PacienteRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final escaladeCONNERSescolaPacienteRecord = snapshot.data!;
          ...
          child: Scaffold(
                                      ...
                                      child: Container(
                                        ...
                                        child: Padding(
                                          ...
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'ESCALADE_C_O_N_N_E_R_SESCOLA_Row_2wdsadi');
            ...
            body: Row(
              ...
              children: [
                ...
                Expanded(
                  child: StreamBuilder<ConnersRecord>(
                    stream:
                        ConnersRecord.getDocument(widget.connersdocumentref!),
                    builder: (context, snapshot) {
                      // Customize what your widget looks like when it's loading.
                      if (!snapshot.hasData) {
                        return Center(
                      ...
                      final columnConnersRecord = snapshot.data!;
                      return Column(
                        mainAxisSize: MainAxisSize.max,
                                                            ...
                                                            children: [
                                                              InkWell(
                                                                ...
                                                                onTap:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'ESCALADE_C_O_N_N_E_R_SESCOLA_Icon_h1o3b6');
                                                              ...
                                                              Container(
                                                                ...
                                                                child: InkWell(
                                                                  ...
                                                                  onTap:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'ESCALADE_C_O_N_N_E_R_SESCOLA_Card_hdu1ml');
                                                              ...
                                                              children: [
                                                                InkWell(
                                                                  ...
                                                                  onTap:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'ESCALADE_C_O_N_N_E_R_SESCOLA_Icon_q5kb30');
                                                                ...
                                                                Padding(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    future:
                                                                      ...
                                                                      queryBuilder: (notificacaoRecord) => notificacaoRecord.where(
                                                                          'lida',
                                                                          isEqualTo:
                                                                              false),
                                                                    ),
                                                                      ...
                                                                      return Container(
                                                                        ...
                                                                        child: badges
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            onPressed:
                                                                                () async {
                                                                              logFirebaseEvent('ESCALADE_C_O_N_N_E_R_SESCOLA_notificatio');
                                                                ...
                                                                Container(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    onTap:
                                                                        () async {
                                                                      logFirebaseEvent(
                                                                          'ESCALADE_C_O_N_N_E_R_SESCOLA_Card_y6cdvw');
                                                                      await showModalBottomSheet(
                                                                        isScrollControlled:
                                                                            true,
                                                                        backgroundColor:
                                                    ...
                                                    padding:
                                                        EdgeInsetsDirectional
                                                            .fromSTEB(16.0, 0.0,
                                                                16.0, 20.0),
                                                    child: Text(
                                                      'Conners Scale for Parents and Teachers\nA Escala Compreensiva de Avaliação do Comportamento do Conners (CBRS) é um instrumento amplo, com vários informações, usados para obter uma ampla compreensão ou visão geral dos comportamentos.',
                                                      textAlign:
                                                          TextAlign.center,
                                                      style:
                                                          FlutterFlowTheme.of(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: FFButtonWidget(
                                          onPressed: () async {
                                            logFirebaseEvent(
                                                'ESCALADE_C_O_N_N_E_R_SESCOLA_FINALIZAR_B');

                                            final paraEscolaCreateData =
                                                createParaEscolaRecordData(
                                              resultado: valueOrDefault<int>(
                                                functions.somarConnersProf(
                                                    _model.q1Value,
                                                    _model.q2Value,
                                                    0,
                                                    _model.q3Value,
                                            ...
                                            await ParaEscolaRecord.createDoc(
                                                    columnConnersRecord
                                                        .reference)
                                                .set(paraEscolaCreateData);

                                            final connersUpdateData =
                                                createConnersRecordData(
                                              cricouparaescola: true,
                                            );
                                            await columnConnersRecord.reference
                                                .update(connersUpdateData);
