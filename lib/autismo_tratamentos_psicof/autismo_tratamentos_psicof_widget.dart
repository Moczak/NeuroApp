...
import 'autismo_tratamentos_psicof_model.dart';
export 'autismo_tratamentos_psicof_model.dart';

class AutismoTratamentosPsicofWidget extends StatefulWidget {
  const AutismoTratamentosPsicofWidget({Key? key}) : super(key: key);

  @override
  _AutismoTratamentosPsicofWidgetState createState() =>
      _AutismoTratamentosPsicofWidgetState();
}

class _AutismoTratamentosPsicofWidgetState
    extends State<AutismoTratamentosPsicofWidget>
    with TickerProviderStateMixin {
  late AutismoTratamentosPsicofModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AutismoTratamentosPsicofModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'AutismoTratamentosPsicof'});
                                  ...
                                  child: Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'AUTISMO_TRATAMENTOS_PSICOF_Row_dhia327o_');
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'AUTISMO_TRATAMENTOS_PSICOF_Icon_r2zdiebb');
                                                ...
                                                children: [
                                                  Container(
                                                    ...
                                                    child: InkWell(
                                                      ...
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'AUTISMO_TRATAMENTOS_PSICOF_Card_ondhigj9');
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    InkWell(
                                                      ...
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'AUTISMO_TRATAMENTOS_PSICOF_Icon_rz5il9qi');
                                                  ...
                                                  children: [
                                                            ...
                                                            child: badges.Badge(
                                                              ...
                                                              child:
                                                                ...
                                                                onPressed:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'AUTISMO_TRATAMENTOS_PSICOF_notifications');
                                                                  scaffoldKey
                                                                      .currentState!
                                                                      .openEndDrawer();
                                                                },
                                                    ...
                                                    Container(
                                                      ...
                                                      child: InkWell(
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'AUTISMO_TRATAMENTOS_PSICOF_Card_yznktyh3');
                                                          await showModalBottomSheet(
                                                            isScrollControlled:
                                                                true,
                                                            backgroundColor:
                              ...
                              child: Container(
                                ...
                                child: Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 15.0, 0.0, 0.0),
                                  child:
                                      StreamBuilder<List<AutismoremedioRecord>>(
                                    stream: queryAutismoremedioRecord(
                                      queryBuilder: (autismoremedioRecord) =>
                                          autismoremedioRecord.orderBy('titulo',
                                              descending: true),
                                    ),
                                    builder: (context, snapshot) {
                                      // Customize what your widget looks like when it's loading.
                                      ...
                                      List<AutismoremedioRecord>
                                          columnAutismoremedioRecordList =
                                          snapshot.data!;
                                      return SingleChildScrollView(
                                        child: Column(
                                          ...
                                          children: List.generate(
                                              columnAutismoremedioRecordList
                                                  .length, (columnIndex) {
                                            final columnAutismoremedioRecord =
                                                columnAutismoremedioRecordList[
                                                    columnIndex];
                                            return Visibility(
                                              visible:
                                              ...
                                              child: Padding(
                                                ...
                                                child: InkWell(
                                                  ...
                                                  onTap: () async {
                                                    logFirebaseEvent(
                                                        'AUTISMO_TRATAMENTOS_PSICOF_Container_rsl');
                                                    await showModalBottomSheet(
