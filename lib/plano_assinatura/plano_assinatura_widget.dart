...
export 'plano_assinatura_model.dart';

class PlanoAssinaturaWidget extends StatefulWidget {
  const PlanoAssinaturaWidget({Key? key}) : super(key: key);

  @override
  _PlanoAssinaturaWidgetState createState() => _PlanoAssinaturaWidgetState();
}

class _PlanoAssinaturaWidgetState extends State<PlanoAssinaturaWidget>
    with TickerProviderStateMixin {
  late PlanoAssinaturaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PlanoAssinaturaModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'PlanoAssinatura'});
    setupAnimations(
                                  ...
                                  child: Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'PLANO_ASSINATURA_Row_jbp3npss_ON_TAP');
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'PLANO_ASSINATURA_Icon_4adu9rvz_ON_TAP');
                                                      context.safePop();
                                                    },
                                                    child: Icon(
                                                    ...
                                                    child: AuthUserStreamWidget(
                                                      builder: (context) =>
                                                        ...
                                                        valueOrDefault<String>(
                                                          'Plano: ${valueOrDefault(currentUserDocument?.nomedoplano, '')}',
                                                          'Nenhum Plano',
                                                        ),
                                                        style:
                                                            FlutterFlowTheme.of(
                                                ...
                                                children: [
                                                  Container(
                                                    ...
                                                    child: InkWell(
                                                      ...
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'PLANO_ASSINATURA_Card_7t78nd1l_ON_TAP');
                                                  ...
                                                  children: [
                                                            ...
                                                            child: badges.Badge(
                                                              ...
                                                              child:
                                                                ...
                                                                onPressed:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'PLANO_ASSINATURA_notifications_none_ICN_');
                                                                  scaffoldKey
                                                                      .currentState!
                                                                      .openEndDrawer();
                                                                },
                                                    ...
                                                    Container(
                                                      ...
                                                      child: InkWell(
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'PLANO_ASSINATURA_Card_xjp50hka_ON_TAP');
                                                          await showModalBottomSheet(
                                                            isScrollControlled:
                                                                true,
                                                            backgroundColor:
                                    ...
                                    children: [
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: AuthUserStreamWidget(
                                                    builder: (context) =>
                                                      ...
                                                      onPressed: () async {
                                                        logFirebaseEvent(
                                                            'PLANO_ASSINATURA_CRIAR_UMA_ASSINATURA_BT');
                                                        if (valueOrDefault(
                                                                currentUserDocument
                                                                    ?.statusunimestre,
                                                                '') ==
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: AuthUserStreamWidget(
                                                    builder: (context) =>
                                                      ...
                                                      onPressed: () async {
                                                        logFirebaseEvent(
                                                            'PLANO_ASSINATURA_CENCELAR_ASSINATURA_BTN');
                                                        var _shouldSetState =
                                                            false;
                                                        ...
                                                        if (confirmDialogResponse) {
                                                          _model.apiResultce7 =
                                                              await StripecancelaassinaturaCall
                                                                  .call(
                                                            idassinaturastripe:
                                                                valueOrDefault(
                                                                    currentUserDocument
                                                              ...
                                                              builder:
                                                                ...
                                                                return AlertDialog(
                                                                  title: Text(
                                                                      'Falha ao cancelar'),
                                                                  content: Text(
                                                                      'Tivemos um problema ao cancelar sua assinatura. Entre em contato com o suporte.'),
                                                                  actions: [
                                                                    TextButton(
                                                                      onPressed:
                                                                          () =>
                                      ...
                                      Padding(
                                        ...
                                        child: Container(
                                          ...
                                          child: wrapWithModel(
                                            model: _model.table04InvoicesModel,
                                            updateCallback: () =>
                                                setState(() {}),
                                            child: Table04InvoicesWidget(
