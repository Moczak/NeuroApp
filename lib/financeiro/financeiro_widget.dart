...
class FinanceiroWidget extends StatefulWidget {
  const FinanceiroWidget({Key? key}) : super(key: key);

  @override
  _FinanceiroWidgetState createState() => _FinanceiroWidgetState();
}
...
class _FinanceiroWidgetState extends State<FinanceiroWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Financeiro'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('FINANCEIRO_PAGE_Financeiro_ON_INIT_STATE');
      setState(() {
        _model.menu = false;
      });
    });
                                  ...
                                  child: Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'FINANCEIRO_PAGE_Row_diq1qf8n_ON_TAP');
            ...
            if (responsiveVisibility(
              ...
              wrapWithModel(
                ...
                child: MainWebNavWidget(
                  ...
                  navThree: FlutterFlowTheme.of(context).menuBGLight,
                                                ...
                                                children: [
                                                          ...
                                                          child: badges.Badge(
                                                            ...
                                                            child:
                                                              ...
                                                              onPressed:
                                                                  () async {
                                                                logFirebaseEvent(
                                                                    'FINANCEIRO_notifications_none_ICN_ON_TAP');
                                                                scaffoldKey
                                                                    .currentState!
                                                                    .openEndDrawer();
                                                              },
                                                  ...
                                                  Container(
                                                    ...
                                                    child: InkWell(
                                                      ...
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'FINANCEIRO_PAGE_Card_os52kbmi_ON_TAP');
                                                  ...
                                                  children: [
                                                        ...
                                                        child: Container(
                                                          ...
                                                          child: FFButtonWidget(
                                                            onPressed:
                                                                () async {
                                                              logFirebaseEvent(
                                                                  'FINANCEIRO_PAGE_DESPESAS_BTN_ON_TAP');
                                                    ...
                                                    Container(
                                                      ...
                                                      child: InkWell(
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'FINANCEIRO_PAGE_Card_0c8to1pk_ON_TAP');
                                                          await showModalBottomSheet(
                                                            isScrollControlled:
                                                                true,
                                                            backgroundColor:
                                              ...
                                              if (!_model.menu)
                                                Padding(
                                                  ...
                                                  child: InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'FINANCEIRO_IconFiltroDesativado_ON_TAP');
                                                      setState(() {
                                                        _model.menu = true;
                                                      });
                                                      if (animationsMap[
                                              ...
                                              if (_model.menu)
                                                Padding(
                                                  ...
                                                  child: InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'FINANCEIRO_PAGE_IconFiltroAtivo_ON_TAP');
                                                      setState(() {
                                                        _model.menu = false;
                                                      });
                                                    },
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    InkWell(
                                                                      ...
                                                                      onTap:
                                                                          () async {
                                                                        logFirebaseEvent(
                                                                            'FINANCEIRO_PAGE_Icon_gdkhc1z6_ON_TAP');
                                                                ...
                                                                children: [
                                                                  ...
                                                                  InkWell(
                                                                    ...
                                                                    onTap:
                                                                        () async {
                                                                      logFirebaseEvent(
                                                                          'FINANCEIRO_PAGE_Icon_dr8iwxdg_ON_TAP');
                                                  ...
                                                  Align(
                                                    ...
                                                    child: Padding(
                                                      ...
                                                      child: InkWell(
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'FINANCEIRO_PAGE_Icon_6nj7uoou_ON_TAP');
                                                          await showModalBottomSheet(
                                                            isScrollControlled:
                                                                true,
                                                            backgroundColor:
                                                  ...
                                                  Align(
                                                    ...
                                                    child: Padding(
                                                      ...
                                                      child: InkWell(
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'FINANCEIRO_PAGE_Icon_14vlz2i8_ON_TAP');
                                                          await showModalBottomSheet(
                                                            isScrollControlled:
                                                                true,
                                                            backgroundColor:
                                                      ...
                                                      Align(
                                                        ...
                                                        child: Padding(
                                                          ...
                                                          child: InkWell(
                                                            ...
                                                            onTap: () async {
                                                              logFirebaseEvent(
                                                                  'FINANCEIRO_PAGE_Icon_ikhrs7kd_ON_TAP');
