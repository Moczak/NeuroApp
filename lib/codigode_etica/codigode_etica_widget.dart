...
import '/components/codigodeetica_widget.dart';
...
import 'codigode_etica_model.dart';
export 'codigode_etica_model.dart';

class CodigodeEticaWidget extends StatefulWidget {
  const CodigodeEticaWidget({Key? key}) : super(key: key);

  @override
  _CodigodeEticaWidgetState createState() => _CodigodeEticaWidgetState();
}

class _CodigodeEticaWidgetState extends State<CodigodeEticaWidget>
    with TickerProviderStateMixin {
  late CodigodeEticaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CodigodeEticaModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'CodigodeEtica'});
    setupAnimations(
                                  ...
                                  child: Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'CODIGODE_ETICA_PAGE_Row_yq3c92na_ON_TAP');
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'CODIGODE_ETICA_PAGE_Icon_ztai1dxg_ON_TAP');
                                                ...
                                                children: [
                                                  Container(
                                                    ...
                                                    child: InkWell(
                                                      ...
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'CODIGODE_ETICA_PAGE_Card_hk0tytse_ON_TAP');
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    InkWell(
                                                      ...
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'CODIGODE_ETICA_PAGE_Icon_33raea5f_ON_TAP');
                                                  ...
                                                  children: [
                                                            ...
                                                            child: badges.Badge(
                                                              ...
                                                              child:
                                                                ...
                                                                onPressed:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'CODIGODE_ETICA_notifications_none_ICN_ON');
                                                                  scaffoldKey
                                                                      .currentState!
                                                                      .openEndDrawer();
                                                                },
                                                    ...
                                                    Container(
                                                      ...
                                                      child: InkWell(
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'CODIGODE_ETICA_PAGE_Card_e5x7rpkh_ON_TAP');
                                                          await showModalBottomSheet(
                                                            isScrollControlled:
                                                                true,
                                                            backgroundColor:
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          8.0, 15.0, 8.0, 0.0),
                                      child: StreamBuilder<
                                          List<CodigodeeticaRecord>>(
                                        stream: queryCodigodeeticaRecord(
                                          queryBuilder: (codigodeeticaRecord) =>
                                              codigodeeticaRecord
                                                  .orderBy('capitulo'),
                                        ),
                                        builder: (context, snapshot) {
                                          ...
                                          List<CodigodeeticaRecord>
                                              listViewCodigodeeticaRecordList =
                                              snapshot.data!;
                                          return ListView.builder(
                                            padding: EdgeInsets.zero,
                                            shrinkWrap: true,
                                            ...
                                            itemBuilder:
                                              ...
                                              final listViewCodigodeeticaRecord =
                                                  listViewCodigodeeticaRecordList[
                                                      listViewIndex];
                                              return Padding(
                                                padding: EdgeInsetsDirectional
                                                ...
                                                child: InkWell(
                                                  ...
                                                  onTap: () async {
                                                    logFirebaseEvent(
                                                        'CODIGODE_ETICA_Container_wr85bzdd_ON_TAP');
                                                    await showModalBottomSheet(
