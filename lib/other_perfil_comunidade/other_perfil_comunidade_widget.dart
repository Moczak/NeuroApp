...
import 'other_perfil_comunidade_model.dart';
export 'other_perfil_comunidade_model.dart';

class OtherPerfilComunidadeWidget extends StatefulWidget {
  const OtherPerfilComunidadeWidget({
    Key? key,
    this.userref,
  }) : super(key: key);
  ...
  @override
  _OtherPerfilComunidadeWidgetState createState() =>
      _OtherPerfilComunidadeWidgetState();
}

class _OtherPerfilComunidadeWidgetState
    extends State<OtherPerfilComunidadeWidget> with TickerProviderStateMixin {
  late OtherPerfilComunidadeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OtherPerfilComunidadeModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'OtherPerfilComunidade'});
    setupAnimations(
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final otherPerfilComunidadeUsersRecord = snapshot.data!;
                                      ...
                                      child: Container(
                                        ...
                                        child: Padding(
                                          ...
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'OTHER_PERFIL_COMUNIDADE_Row_9xnzodsz_ON_');
                                                    ...
                                                    children: [
                                                      Container(
                                                        ...
                                                        child: InkWell(
                                                          ...
                                                          onTap: () async {
                                                            logFirebaseEvent(
                                                                'OTHER_PERFIL_COMUNIDADE_Card_ah4k9j6m_ON');
                                                      ...
                                                      children: [
                                                                ...
                                                                child: badges
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    onPressed:
                                                                        () async {
                                                                      logFirebaseEvent(
                                                                          'OTHER_PERFIL_COMUNIDADE_notifications_no');
                                                                      scaffoldKey
                                                                          .currentState!
                                                                          .openEndDrawer();
                                                                    },
                                                        ...
                                                        Container(
                                                          ...
                                                          child: InkWell(
                                                            ...
                                                            onTap: () async {
                                                              logFirebaseEvent(
                                                                  'OTHER_PERFIL_COMUNIDADE_Card_02fuyg7n_ON');
                                                              await showModalBottomSheet(
                                                                isScrollControlled:
                                                                    true,
                                                                backgroundColor:
                          ...
                          child: Column(
                            ...
                            children: [
                                              ...
                                              children: [
                                                Padding(
                                                  ...
                                                  child: FlutterFlowIconButton(
                                                    ...
                                                    onPressed: () async {
                                                      logFirebaseEvent(
                                                          'OTHER_PERFIL_COMUNIDADE_arrow_back_ios_I');
                                                            ...
                                                            decoration:
                                                              ...
                                                              image:
                                                                ...
                                                                image: Image
                                                                  ...
                                                                  valueOrDefault<
                                                                      String>(
                                                                    otherPerfilComunidadeUsersRecord
                                                                        .photoUrl,
                                              ...
                                              children: [
                                                Column(
                                                  ...
                                                  children: [
                                                      ...
                                                      padding:
                                                          EdgeInsetsDirectional
                                                              .fromSTEB(
                                                                  ...
                                                                  0.0),
                                                      child: Text(
                                                        '${otherPerfilComunidadeUsersRecord.displayName} ${otherPerfilComunidadeUsersRecord.sobrenome}',
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                                .bodyMedium
                                                    ...
                                                    if (otherPerfilComunidadeUsersRecord
                                                            .mostrartelefone ??
                                                        true)
                                                      Padding(
                                                        padding:
                                                    ...
                                                    builder: (context) =>
                                                      ...
                                                      builder:
                                                        ...
                                                        return InkWell(
                                                          ...
                                                          onTap: () async {
                                                            logFirebaseEvent(
                                                                'OTHER_PERFIL_COMUNIDADE_FollowUnfollowBu');
                                                            if ((currentUserDocument
                                                              ...
                                                              triggerPushNotification(
                                                                notificationTitle:
                                                                    'Novo Seguidor!',
                                                                notificationText:
                                                                    '${currentUserDisplayName}começou a seguir você.',
                                                              ...
                                                              child: Padding(
                                                                ...
                                                                child: Row(
                                                                  ...
                                                                  children: [
                                                                    Text(
                                                                      () {
                                                                        if (otherPerfilComunidadeUsersRecord.following!.toList().contains(currentUserReference) &&
                                                                            !(currentUserDocument?.following?.toList() ?? []).contains(otherPerfilComunidadeUsersRecord.reference)) {
                                                                          return 'Seguir de Volta';
                                                                        } else if (!otherPerfilComunidadeUsersRecord.following!.toList().contains(currentUserReference) &&
                                                                            !(currentUserDocument?.following?.toList() ?? []).contains(otherPerfilComunidadeUsersRecord.reference)) {
                                                                          return 'Seguir';
                                                                        } else {
                                                                          return 'Não Seguir';
                                                                      ...
                                                                      style: FlutterFlowTheme.of(
                                                                          ...
                                                                          .override(
                                                                            fontFamily:
                                                                                FlutterFlowTheme.of(context).bodyMediumFamily,
                                                                            color: (currentUserDocument?.following?.toList() ?? []).contains(followUnfollowButtonFollowersRecord!.reference)
                              ...
                              Container(
                                ...
                                child: FutureBuilder<List<FollowersRecord>>(
                                  future: queryFollowersRecordOnce(
                                    parent: otherPerfilComunidadeUsersRecord
                                        .reference,
                                    singleRecord: true,
                                  ),
                                  builder: (context, snapshot) {
                                          ...
                                          Align(
                                            ...
                                            child: TabBar(
                                              ...
                                              tabs: [
                                                ...
                                                Tab(
                                                  text: valueOrDefault<String>(
                                                    '${otherPerfilComunidadeUsersRecord.following!.toList().length.toString()} Seguindo',
                                                    '0 Seguindo',
                                                  ),
                                                ),
                                                Tab(
                                                          ...
                                                          itemBuilder: (context,
                                                            ...
                                                            return Container(
                                                              ...
                                                              child:
                                                                ...
                                                                key: Key(
                                                                    'Key2az_${followersIndex}_of_${followers.length}'),
                                                                users:
                                                                    followersItem,
                                                              ),
                                                            );
                                                          ...
                                                          itemBuilder: (context,
                                                            ...
                                                            return Container(
                                                              ...
                                                              child:
                                                                  FollowerComponentWidget(
                                                                key: Key(
                                                                    'Keyzvj_${followingIndex}_of_${following.length}'),
                                                                users:
                                                                    followingItem,
                                                              ),
                                                            );
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            InkWell(
                                                                              ...
                                                                              highlightColor: Colors.transparent,
                                                                              onTap: () async {
                                                                                logFirebaseEvent('OTHER_PERFIL_COMUNIDADE_Row_qhgwtzve_ON_');
                                                                            ...
                                                                            Row(
                                                                              ...
                                                                              children: [
                                                                                            ...
                                                                                            if (!socialFeedPostagensRecord.likes!.toList().contains(currentUserReference))
                                                                                              Align(
                                                                                                ...
                                                                                                child: InkWell(
                                                                                                  ...
                                                                                                  highlightColor: Colors.transparent,
                                                                                                  onTap: () async {
                                                                                                    logFirebaseEvent('OTHER_PERFIL_COMUNIDADE_Icon_jrhvev21_ON');
                                                                                            ...
                                                                                            if (socialFeedPostagensRecord.likes!.toList().contains(currentUserReference))
                                                                                              Align(
                                                                                                ...
                                                                                                child: InkWell(
                                                                                                  ...
                                                                                                  highlightColor: Colors.transparent,
                                                                                                  onTap: () async {
                                                                                                    logFirebaseEvent('OTHER_PERFIL_COMUNIDADE_Icon_qrkzaadm_ON');
                                                                                ...
                                                                                InkWell(
                                                                                  ...
                                                                                  highlightColor: Colors.transparent,
                                                                                  onTap: () async {
                                                                                    logFirebaseEvent('OTHER_PERFIL_COMUNIDADE_chats_ON_TAP');
                                                                                    await showModalBottomSheet(
