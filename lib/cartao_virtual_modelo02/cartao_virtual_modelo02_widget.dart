...
import 'cartao_virtual_modelo02_model.dart';
export 'cartao_virtual_modelo02_model.dart';

class CartaoVirtualModelo02Widget extends StatefulWidget {
  const CartaoVirtualModelo02Widget({Key? key}) : super(key: key);

  @override
  _CartaoVirtualModelo02WidgetState createState() =>
      _CartaoVirtualModelo02WidgetState();
}

class _CartaoVirtualModelo02WidgetState
    extends State<CartaoVirtualModelo02Widget> with TickerProviderStateMixin {
  late CartaoVirtualModelo02Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CartaoVirtualModelo02Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'CartaoVirtualModelo02'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('CARTAO_VIRTUAL_MODELO02_CartaoVirtualMod');
      setState(() {
                                  ...
                                  child: Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'CARTAO_VIRTUAL_MODELO02_Row_sgctggey_ON_');
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'CARTAO_VIRTUAL_MODELO02_Icon_ne5kt8qt_ON');
                                                ...
                                                children: [
                                                  Container(
                                                    ...
                                                    child: InkWell(
                                                      ...
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'CARTAO_VIRTUAL_MODELO02_Card_hdghzoat_ON');
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    InkWell(
                                                      ...
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'CARTAO_VIRTUAL_MODELO02_Icon_8nr2q64t_ON');
                                                  ...
                                                  children: [
                                                            ...
                                                            child: badges.Badge(
                                                              ...
                                                              child:
                                                                ...
                                                                onPressed:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'CARTAO_VIRTUAL_MODELO02_notifications_no');
                                                                  scaffoldKey
                                                                      .currentState!
                                                                      .openEndDrawer();
                                                                },
                                                    ...
                                                    Container(
                                                      ...
                                                      child: InkWell(
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'CARTAO_VIRTUAL_MODELO02_Card_zvx30ngv_ON');
                                                          await showModalBottomSheet(
                                                            isScrollControlled:
                                                                true,
                                                            backgroundColor:
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        onPressed:
                                                                            () async {
                                                                          logFirebaseEvent(
                                                                              'CARTAO_VIRTUAL_MODELO02_edit_outlined_IC');
                                                                          final selectedMedia =
                                                                              await selectMedia(
                                                                            mediaSource:
                                                                          ...
                                                                          if (selectedMedia != null &&
                                                                            ...
                                                                            if (selectedUploadedFiles.length == selectedMedia.length &&
                                                                              ...
                                                                              setState(() {});
                                                                              showUploadMessage(context, 'Falha no carrengamento da imagem');
                                                                              return;
                                                                            }
                                                                          }
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        onPressed:
                                                                            () async {
                                                                          logFirebaseEvent(
                                                                              'CARTAO_VIRTUAL_MODELO02_link_ICN_ON_TAP');
                                                                          setState(
                                                                              () {
                                                                            _model.mostrarlinks =
                                                                                true;
                                                                              ...
                                                                              children: [
                                                                                ...
                                                                                Align(
                                                                                  ...
                                                                                  child: FlutterFlowIconButton(
                                                                                    ...
                                                                                    onPressed: () async {
                                                                                      logFirebaseEvent('CARTAO_VIRTUAL_MODELO02_edit_outlined_IC');
                                                                                      ...
                                                                                      setState(() {
                                                                                        _model.coricones = _model.colorPicked2!;
                                                                                      });
                                                                                    },
                                                                                  ),
                                                                                ),
                                                                              ...
                                                                              child: FlutterFlowIconButton(
                                                                                ...
                                                                                onPressed: () async {
                                                                                  ...
                                                                                  final _colorPicked3Color = await showFFColorPicker(
                                                                                    context,
                                                                                    currentColor: _model.colorPicked3 ??= valueOrDefault<Color>(
                                                                                      _model.corfooter,
                                                                                      FlutterFlowTheme.of(context).alternate,
                                                                                    ),
                                                                                    showRecentColors: true,
                                                                                  ...
                                                                                  setState(() {
                                                                                    _model.corfooter = _model.colorPicked3!;
                                                                                  });
                                                                                },
                                                                              ),
                                                                            ),
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    InkWell(
                                                      ...
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'CARTAO_VIRTUAL_MODELO02_Icon_3i6qslu0_ON');
                                                        setState(() {
                                                          _model.mostrarlinks =
                                                              false;
                                                        });
                                                ...
                                                children: [
                                                  Padding(
                                                    ...
                                                    child: FFButtonWidget(
                                                      onPressed: () async {
                                                        logFirebaseEvent(
                                                            'CARTAO_VIRTUAL_MODELO02_SALVAR_BTN_ON_TA');
                                                        setState(() {
                                                          _model.localizacao =
                                                              _model
                      ...
                      children: [
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'CARTAO_VIRTUAL_MODELO02_GERAR_CARTÃO_BTN');
