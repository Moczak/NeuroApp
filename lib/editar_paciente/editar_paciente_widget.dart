...
import 'editar_paciente_model.dart';
export 'editar_paciente_model.dart';

class EditarPacienteWidget extends StatefulWidget {
  const EditarPacienteWidget({
    Key? key,
    this.dadosdopacienteeditar,
  }) : super(key: key);

  final DocumentReference? dadosdopacienteeditar;

  @override
  _EditarPacienteWidgetState createState() => _EditarPacienteWidgetState();
}

class _EditarPacienteWidgetState extends State<EditarPacienteWidget>
    with TickerProviderStateMixin {
  late EditarPacienteModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditarPacienteModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'EditarPaciente'});
    setupAnimations(
                                  ...
                                  child: Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'EDITAR_PACIENTE_PAGE_Row_ap71q4br_ON_TAP');
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'EDITAR_PACIENTE_Icon_h54an2gd_ON_TAP');
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'EDITAR_PACIENTE_Container_p6dac011_ON_TA');
                                        ...
                                        children: [
                                          Padding(
                                            ...
                                            child: InkWell(
                                              ...
                                              onTap: () async {
                                                logFirebaseEvent(
                                                    'EDITAR_PACIENTE_Column_mg3wyueq_ON_TAP');
                                                context.pop();
                                              },
                                              child: Column(
                                                mainAxisSize: MainAxisSize.max,
                                                  ...
                                                  Row(
                                                    ...
                                                    children: [
                                                      InkWell(
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'EDITAR_PACIENTE_Icon_295jq0ri_ON_TAP');
                                                  ...
                                                  children: [
                                                            ...
                                                            child: badges.Badge(
                                                              ...
                                                              child:
                                                                ...
                                                                onPressed:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'EDITAR_PACIENTE_notifications_none_ICN_O');
                                                                  scaffoldKey
                                                                      .currentState!
                                                                      .openEndDrawer();
                                                                },
                                                    ...
                                                    Container(
                                                      ...
                                                      child: InkWell(
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'EDITAR_PACIENTE_Card_sbtyf9o8_ON_TAP');
                                                          await showModalBottomSheet(
                                                            isScrollControlled:
                                                                true,
                                                            backgroundColor:
                                                            ...
                                                            children: [
                                                              FFButtonWidget(
                                                                onPressed:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'EDITAR_PACIENTE_ALTERAR_FOTO_BTN_ON_TAP');
                                                                  final selectedMedia =
                                ...
                                Expanded(
                                  child: Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'EDITAR_PACIENTE_ATUALIZAR_BTN_ON_TAP');
                                        ...
                                        final pacienteUpdateData =
                                          ...
                                          telefone: _model.telController.text,
                                        ...
                                        await widget.dadosdopacienteeditar!
                                            .update(pacienteUpdateData);
                                ...
                                Expanded(
                                  child: Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'EDITAR_PACIENTE_PAGE_EXCLUIR_BTN_ON_TAP');
