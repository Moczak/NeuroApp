...
import 'gerar_a_s_r_s18_model.dart';
export 'gerar_a_s_r_s18_model.dart';

class GerarASRS18Widget extends StatefulWidget {
  const GerarASRS18Widget({
    Key? key,
    this.pacienteref,
  }) : super(key: key);
  ...
  @override
  _GerarASRS18WidgetState createState() => _GerarASRS18WidgetState();
}

class _GerarASRS18WidgetState extends State<GerarASRS18Widget>
    with TickerProviderStateMixin {
  late GerarASRS18Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GerarASRS18Model());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'GerarASRS18'});
    setupAnimations(
                                  ...
                                  child: Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'GERAR_A_S_R_S18_PAGE_Row_vw960d6x_ON_TAP');
                                                  ...
                                                  Row(
                                                    ...
                                                    children: [
                                                      InkWell(
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'GERAR_A_S_R_S18_Icon_hqjqntml_ON_TAP');
                                                    ...
                                                    children: [
                                                      Container(
                                                        ...
                                                        child: InkWell(
                                                          ...
                                                          onTap: () async {
                                                            logFirebaseEvent(
                                                                'GERAR_A_S_R_S18_Card_ch5l12aa_ON_TAP');
                                                    ...
                                                    Row(
                                                      ...
                                                      children: [
                                                        InkWell(
                                                          ...
                                                          onTap: () async {
                                                            logFirebaseEvent(
                                                                'GERAR_A_S_R_S18_Icon_p07p3x5q_ON_TAP');
                                                      ...
                                                      children: [
                                                                ...
                                                                child: badges
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    onPressed:
                                                                        () async {
                                                                      logFirebaseEvent(
                                                                          'GERAR_A_S_R_S18_notifications_none_ICN_O');
                                                                      scaffoldKey
                                                                          .currentState!
                                                                          .openEndDrawer();
                                                                    },
                                                        ...
                                                        Container(
                                                          ...
                                                          child: InkWell(
                                                            ...
                                                            onTap: () async {
                                                              logFirebaseEvent(
                                                                  'GERAR_A_S_R_S18_Card_htmrlgzo_ON_TAP');
                                                              await showModalBottomSheet(
                                                                isScrollControlled:
                                                                    true,
                                                                backgroundColor:
                            ...
                            Expanded(
                              child: Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'GERAR_A_S_R_S18_FINALIZAR_BTN_ON_TAP');
                                    ...
                                    _model.criouasrs18 =
                                        Asrs18Record.getDocumentFromData(
                                            asrs18CreateData,
                                    ...
                                    await ParteARecord.createDoc(
                                            _model.criouasrs18!.reference)
                            ...
                            Expanded(
                              child: Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'GERAR_A_S_R_S18_COMPARTILHAR_BTN_ON_TAP');
