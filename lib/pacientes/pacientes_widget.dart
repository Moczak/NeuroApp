  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<PacienteRecord>>(
      stream: queryPacienteRecord(
        queryBuilder: (pacienteRecord) => pacienteRecord
      ...
      builder: (context, snapshot) {
        ...
        List<PacienteRecord> pacientesPacienteRecordList = snapshot.data!;
                                      ...
                                      child: Container(
                                        ...
                                        child: Padding(
                                          ...
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'PACIENTES_PAGE_Row_28wqgz8o_ON_TAP');
                    ...
                    children: [
                                                  ...
                                                  return Container(
                                                    ...
                                                    child: badges.Badge(
                                                      ...
                                                      child:
                                                        ...
                                                        onPressed: () async {
                                                          logFirebaseEvent(
                                                              'PACIENTES_notifications_none_ICN_ON_TAP');
                                                          scaffoldKey
                                                              .currentState!
                                                              .openEndDrawer();
                                                        },
                                              ...
                                              children: [
                                                Container(
                                                  ...
                                                  child: InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'PACIENTES_PAGE_Card_xbuu7uz8_ON_TAP');
                                                      ...
                                                      children: [
                                                            ...
                                                            child: Container(
                                                              ...
                                                              child:
                                                                ...
                                                                onPressed:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'PACIENTES_PAGE_ADICIONAR_BTN_ON_TAP');
                                                        ...
                                                        Container(
                                                          ...
                                                          child: InkWell(
                                                            ...
                                                            onTap: () async {
                                                              logFirebaseEvent(
                                                                  'PACIENTES_PAGE_Card_qnczklff_ON_TAP');
                                                              await showModalBottomSheet(
                                                                isScrollControlled:
                                                                    true,
                                                                backgroundColor:
                                              ...
                                              children: [
                                                Padding(
                                                  ...
                                                  child: FutureBuilder<
                                                      List<PacienteRecord>>(
                                                    future:
                                                        queryPacienteRecordOnce(
                                                      queryBuilder: (pacienteRecord) =>
                                                          pacienteRecord.where(
                                                              'usuario',
                                                              isEqualTo:
                                                                  currentUserReference),
                                                    ),
                                                  ...
                                                  child: FutureBuilder<
                                                    ...
                                                    builder:
                                                      ...
                                                      List<ReceitatotalRecord>
                                                          ...
                                                          snapshot.data!;
                                                      final containerReceitatotalRecord =
                                                          containerReceitatotalRecordList
                                                                  .isNotEmpty
                                                              ? containerReceitatotalRecordList
                                                                  .first
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: FutureBuilder<
                                              List<PacienteRecord>>(
                                            future: queryPacienteRecordOnce(
                                              queryBuilder: (pacienteRecord) =>
                                                  pacienteRecord.where(
                                                      'usuario',
                                                      isEqualTo:
                                                            ...
                                                            children: [
                                                              ...
                                                              Padding(
                                                                ...
                                                                child: Text(
                                                                  valueOrDefault<
                                                                      String>(
                                                                    'R\$ ${functions.somaLista(containerReceitatotalRecordList.map((e) => e.receitaspagasInt).withoutNulls.toList()).toString()},00',
                                                                    'R\$ 00,00',
                                                                  ),
                                                                  style: FlutterFlowTheme.of(
                                                                          context)
                                  ...
                                  Expanded(
                                    child: Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          16.0, 24.0, 16.0, 16.0),
                                      child:
                                          FutureBuilder<List<PacienteRecord>>(
                                        future: queryPacienteRecordOnce(
                                          queryBuilder: (pacienteRecord) =>
                                              pacienteRecord
                                                  .where('usuario',
                                              ...
                                              return Visibility(
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'PACIENTES_PAGE_Container_hnjiivjg_ON_TAP');
                                                    ...
                                                    onLongPress: () async {
                                                      logFirebaseEvent(
                                                          'PACIENTES_Container_hnjiivjg_ON_LONG_PRE');
                                                      if (animationsMap[
                                                                    ...
                                                                    if (responsiveVisibility(
                                                                      ...
                                                                      Padding(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onTap:
                                                                              () async {
                                                                            logFirebaseEvent('PACIENTES_PAGE_Text_yfbgkmbt_ON_TAP');

                                                                            context.goNamed(
                                                                              'EditarPaciente',
                                                                              queryParams: {
                                                                                'dadosdopacienteeditar': serializeParam(
                                                                                  listViewPacienteRecord.reference,
                                                                    ...
                                                                    Padding(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        onTap:
                                                                            () async {
                                                                          logFirebaseEvent(
                                                                              'PACIENTES_PAGE_Row_7gc4bi4m_ON_TAP');
                                                                          await launchURL(
                                                                              '${listViewPacienteRecord.urlwhats}');
                                                                        },
                                                                        child:
                                                                            Row(
                                                                          mainAxisSize:
                                                                  ...
                                                                  child: Column(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Padding(
                                                                        ...
                                                                        child:
                                                                            Text(
                                                                          '(${listViewPacienteRecord.ddd})  ${listViewPacienteRecord.telefone}',
                                                                          style: FlutterFlowTheme.of(context)
                                                                              .bodySmall
                                                                              .override(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'PACIENTES_PAGE_Icon_as5j3xg7_ON_TAP');
                      ...
                      wrapWithModel(
                        ...
                        child: MobileNavWidget(
                          ...
                          textNavTwo: FlutterFlowTheme.of(context).menuBGLight,
                          textNavThree:
                              FlutterFlowTheme.of(context).secondaryText,
                          textNavFour:
                              FlutterFlowTheme.of(context).secondaryText,
